...
def initial_parameters(layer_dims) :  
    ...
    for x in range(1, numLayers):
        parameters['W'+str(x)]= np.random.randn(layer_dims(1), layer_dims(x-1))*0.01 
...
def update_parameters (parameters, gradients, learning_rate) : 
    ...
    for l in L:
        parameters['W'+str(l+1)] = parameters['W'+str(l+1)] -learning_rate*gradients['W'+str(l+1)]
        parameters['b'+str(l+1)] = parameters['b'+str(l+1)] -  learning_rate*gradients['b'+str(l+1)]
